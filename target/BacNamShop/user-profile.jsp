                ...
                <div class="col-lg-10">
                    ...
                    <div class="text-center mb-5">
                        ...
                        <label class="avatar avatar-xxl avatar-circle avatar-uploader profile-cover-avatar" for="editAvatarUploaderModal">
                            <%
                                UserGoogle user = (UserGoogle) session.getAttribute("userGoogle");
                            %>
                            <%
                                if (user == null) {
                            %>
                        ...
                        <h1 class="page-header-title">${userobj.name} ${userGoogle.name} <i class="bi-patch-check-fill fs-2 text-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Top endorsed"></i></h1>
                            ...
                            <div class="card mb-3 mb-lg-5">
                                ...
                                <div class="card-body">
                                    <ul class="list-unstyled list-py-2 text-dark mb-0">
                                        ...
                                        <li><i class="bi-person dropdown-item-icon"></i> ${userobj.name}${userGoogle.name}</li>
                                        <li><i class="bi-building dropdown-item-icon"></i> </li>

                                        <li class="pt-4 pb-0"><span class="card-subtitle">Contacts</span></li>
                                        <li><i class="bi-at dropdown-item-icon"></i> ${userobj.email} ${userGoogle.email}</li>
