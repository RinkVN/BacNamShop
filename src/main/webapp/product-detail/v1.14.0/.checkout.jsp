    ...
    <head>
        ...
        <style>
            input {
                ...
                pointer-events: none; /* Ngăn chặn các sự kiện chú chuột */
            }
            input#inputCardNumber, input#inputName {
                    ...
                    <div class="row justify-content-between">
                        <div class="col-lg-7 col-xl-7">
                            ...
                            <%                                int id = Integer.parseInt(request.getParameter("id"));
                                UserDAOImpl dao = new UserDAOImpl(DBContext.getConn());
                            ...
                            <form action="../../addorder" method="post">
                                ...
                                <div class="row g-4 mb-7">
                                    ...
                                    <div class="col-5">
                                        <a class="btn-to-payment">
                                            <button disabled="" class="btn btn-primary w-100" >Xác nhận thông tin giao hàng
                                ...
                                <div class="col-12">
                                    <select name="paymentmethod" class="form-select mb-2" aria-label="delivery type">
                                        <option value="cod">
                                ...
                                <a class="btn-to-payment">
                                    <button type="submit" class="btn btn-primary w-100" >Thanh toán đơn hàng
                                        <span class="fas fa-chevron-right ms-1 fs-10"></span>
                                    </button>
                                </a>
                            </form>
                        ...
                        <%     User user = (User) session.getAttribute("userobj");
                            ...
                            List<Cart> cart = dao2.getProductByUser(user.getId());
                            float totalPrice = 0;
