...
document.addEventListener("DOMContentLoaded", function () {
    ...
    tabs.forEach(tab => {
        tab.addEventListener("click", function () {
            // Loại b�? lớp active và show từ tất cả các tab-pane
            tabPanes.forEach(pane => {
                pane.classList.remove("active");
                pane.classList.remove("show");
            });

            // Lấy id của tab mà ngư�?i dùng đã click
...
$(document).ready(function () {
    ...
    // Khi hover vào ảnh nh�?, chuyển đến ảnh tương ứng trong slider chính
    ...
    // Khi click vào ảnh nh�?, chuyển đến ảnh tương ứng trong slider chính
