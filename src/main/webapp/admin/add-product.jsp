                ...
                <form action="../addproduct" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-lg-8 mb-3 mb-lg-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <script>
                                                // Hàm để tạo số ngẫu nhiên có 6 chữ số
                                                function generateRandomSKU() {
                                                    var min = 1000000000;
                                                    var max = 9999999999;
                                                    var skuNumber = Math.floor(Math.random() * (max - min + 1)) + min;
                                                    return skuNumber.toString(); // Chuyển số thành chuỗi
                                                }

                                                // Gán giá trị SKU ngẫu nhiên vào trường nhập
                                                document.getElementById("SKULabel").value = generateRandomSKU();
                                            </script>
                                            <!-- End Form -->
                                        </div>
                                        <!-- End Col -->
                            ...
                            <!-- End Col -->
                            <label class="file-selector">
                                <input type="file" name="pvideo" class="file-selector-input" multiple />
                                Chọn File
                            </label>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="align-items-center mb-3 btn-add-books-main">
                                <button type="submit" class="btn btn-primary" href="add-product.jsp">
                                    Thêm sản phẩm
                                </button>
                            </div>
                        </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h4 class="modal-title" id="addImageFromURLModalLabel">Thêm ảnh từ URL</h4>
                                ...
                                <div class="modal-body">
                                    <label for="pasteImageURLNameLabel" class="form-label">Điền URL ảnh</label>
                                ...
                                <div class="modal-footer gap-3">
                                    <button type="button" class="btn btn-white" data-bs-dismiss="modal" aria-label="Close">Thoát</button>
