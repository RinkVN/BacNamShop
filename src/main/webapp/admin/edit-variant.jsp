...
<html>
    ...
    <body>
        ...
        <!--Block access to admin/add_product.jsp-->
        ...
        <main id="content" role="main" class="main">
            ...
            <div class="content @@layoutBuilder.header.containerMode">
                ...
                <form action="../editvariant" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-lg-8 mb-3 mb-lg-0">
                            <div class="card mb-3 mb-lg-5">
                                <!-- Header -->
                                <div class="card-header">
                                    <h4 class="card-header-title">Sửa Phân Loại</h4>
                                </div>
                                <!-- End Header -->
                                ...
                                <div class="card-body">
                                    <%
                                        ...
                                        VariantInfo v = d.getVariantByProductId(id);
                                        ProductInfo p = d.getProductById(id);
                                    %>
                                    <input 
                                        type="" 
                                        name="id" 
                                ...
                                <div class="card mb-3 mb-lg-5">
                                    ...
                                    <img src="<%= v.getProductSubphoto()%>" alt="alt" style="width: 300px; margin: 0 auto;
